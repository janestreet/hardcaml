...
module T = struct
  ...
  let to_string x = Utils.bstr_of_abits_int (width x) (fst x)
  ...
  let to_bstr x = Utils.bstr_of_abits_int (width x) (fst x)
  ...
  let const b = Utils.abits_int_of_bstr b, String.length b
