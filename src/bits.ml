...
module Mutable = struct
  ...
  external add : (int[@untagged]) -> Bytes.t -> Bytes.t -> Bytes.t -> unit
    = "hardcaml_bits_add_bc" "hardcaml_bits_add" [@@noalloc]
  ...
  external sub : (int[@untagged]) -> Bytes.t -> Bytes.t -> Bytes.t -> unit
    = "hardcaml_bits_sub_bc" "hardcaml_bits_sub" [@@noalloc]
  ...
  external cmpu64 : (Int64.t[@unboxed]) -> (Int64.t[@unboxed]) -> (int[@untagged])
    = "hardcaml_bits_uint64_compare_bc" "hardcaml_bits_uint64_compare" [@@noalloc]
