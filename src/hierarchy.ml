...
module With_interface (I : Interface.S) (O : Interface.S) = struct
  ...
  let create =
    Circuit.with_create_options
      (fun create_options ?port_checks ?instance db ~name create_fn inputs ->
         let circuit =
           Circuit.call_with_create_options
             Circ.create_exn create_options ?port_checks ~name create_fn
         in
...
module In_scope (I : Interface.S) (O : Interface.S) = struct
  ...
  let hierarchical =
    Circuit.with_create_options
      (fun create_options ?port_checks ?instance ~(scope : Scope.t) ~name create_fn inputs ->
