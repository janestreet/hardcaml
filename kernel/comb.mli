(** Combinational logic API.
    ...
    This includes standard arithmetic, logical, equality and comparison operators, as well
    as more hardware specific functions such as bit selection, concatention, multiplexing
    etc.
