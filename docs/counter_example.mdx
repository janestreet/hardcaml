...
- `w` is the bit width of the register.
- `fun d -> ...`: this function receives the current value of the
...
# let testbench create_design_fn =
    ...
    step ~clear:0 ~incr:0
  ;;
val testbench : Hardcaml__.Circuit.With_interface(I)(O).create -> unit =
  <fun>
